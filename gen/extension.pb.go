...
var file_extension_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xf0, 0x01, 0x0a, 0x10, 0x45, 0x78, 0x74, 0x65, 0x6e,
...
var file_extension_proto_goTypes = []interface{}{
	...
	nil,                         // 7: extension.ConfigureRequest.ConfigEntry
	nil,                         // 8: extension.ExecuteRequest.MetadataEntry
}
var file_extension_proto_depIdxs = []int32{
	7, // 0: extension.ConfigureRequest.config:type_name -> extension.ConfigureRequest.ConfigEntry
	6, // 1: extension.ExecuteRequest.args:type_name -> extension.ScalarValue
	8, // 2: extension.ExecuteRequest.metadata:type_name -> extension.ExecuteRequest.MetadataEntry
	6, // 3: extension.ExecuteResponse.outputs:type_name -> extension.ScalarValue
	0, // 4: extension.ExtensionService.Configure:input_type -> extension.ConfigureRequest
	2, // 5: extension.ExtensionService.ListMethods:input_type -> extension.ListMethodsRequest
	4, // 6: extension.ExtensionService.Execute:input_type -> extension.ExecuteRequest
	1, // 7: extension.ExtensionService.Configure:output_type -> extension.ConfigureResponse
	3, // 8: extension.ExtensionService.ListMethods:output_type -> extension.ListMethodsResponse
	5, // 9: extension.ExtensionService.Execute:output_type -> extension.ExecuteResponse
